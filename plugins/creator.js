...
if (command == 'owner') {
 let vcard = `BEGIN:VCARD\nVERSION:3.0\nN:WhatsApp;Saya Owner BAHRI-MODS;Bot;;Md\nFN:Saya Owner BAHRI-MODS WhatsApp, Md\nNICKNAME:👑 Owner BAHRI-MODS\nORG:BAHRI-MODS\nTITLE:BAHRI-MODS\nitem1.TEL;waid=6285853570297:+6285853570297\nitem1.X-ABLabel:📞 Nomor Owner\nitem2.URL:https://s.id/Cerdasin62\nitem2.X-ABLabel:💬 More\nitem3.EMAIL;type=INTERNET:memek@mail.com\nitem3.X-ABLabel:💌 Mail Owner BAHRI-MODS\nitem4.ADR:;;🇮🇩 Indonesia;;;;\nitem4.X-ABADR:💬 More\nitem4.X-ABLabel:📍 Lokasi Saya\nBDAY;value=date:🔖 13 January 2004\nEND:VCARD`
...
if (command == 'creator') {
  ...
  const sentMsg = await conn.sendContactArray(m.chat, [
    [`${nomorown}`, `${await conn.getName(nomorown+'@s.whatsapp.net')}`, `👑 Developer Bot `, `🚫 Don't call me 🥺`, `BAHRI-MODS@gmail.com`, `🇮🇩 Indonesia`, `🚀 https://.github.io/`, `👤 Gada pawang nih senggol dong 😔`],
    [`${conn.user.jid.split('@')[0]}`, `${await conn.getName(conn.user.jid)}`, `🔥 Bot WhatsApp 🐣`, `📵 Don't spam/call me 😢`, `Nothing`, `🇮🇩 Indonesia`, `🚀 https://s.id/kontol/`, `🤖 Hanya bot biasa yang kadang suka eror ☺`]
  ], fakes)
